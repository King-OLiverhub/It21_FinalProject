...
<head>
    ...
    <title>Add Network Device - ThreatPulse</title>
    ...
    <div class="container my-4">
        <div class="form-card">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="m-0 font-bold"><i class="fas fa-network-wired me-2 text-primary"></i>Register Network Device</h2>
                    <p class="text-muted mb-0 small">Enter physical parameters to register a switch, firewall, AP, or router node.</p>
                </div>
            ...
            <form method="POST" action="{{ route('network-devices.store') }}">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="device_name" name="device_name" placeholder="e.g. Gateway-Router-1" value="{{ old('device_name') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="ip_address" class="form-label">IP Address *</label>
                        <input type="text" class="form-control" id="ip_address" name="ip_address" placeholder="e.g. 192.168.1.1" value="{{ old('ip_address') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="mac_address" class="form-label">MAC Address *</label>
                        <input type="text" class="form-control" id="mac_address" name="mac_address" placeholder="e.g. 00:1A:2B:3C:4D:5E" value="{{ old('mac_address') }}" required>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="device_type" name="device_type" required>
                            ...
                            <option value="Access Point" {{ old('device_type') === 'Access Point' ? 'selected' : '' }}>Access Point</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="firmware_version" name="firmware_version" placeholder="e.g. v15.2.4" value="{{ old('firmware_version') }}">
                    </div>
                    <div class="col-md-12">
                        <label for="location" class="form-label">Physical Location</label>
                        <input type="text" class="form-control" id="location" name="location" placeholder="e.g. Core Server Rack 3-A" value="{{ old('location') }}">
                    </div>
                </div>
